<template>
  <q-page-container>
    ...
    <p>
      The remindssong app stores and processes personal data that you have
      ...
      features and it could mean that the remindssong app won’t work properly or
      at all.
    </p>
    <div>
      <p>
    ...
    <p>
      ...
      using the app. Daniel does not promise that it will always update the app
    ...
    <p>These terms and conditions are effective as of 2021-07-18</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about my Terms and Conditions, do
      not hesitate to contact me at dani.erik18ap@gmail.com.
    </p>
    <p>
